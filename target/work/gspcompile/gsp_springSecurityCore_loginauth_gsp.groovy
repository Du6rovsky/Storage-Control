...
createTagBody(1, {->
printHtmlPart(4)
invokeTag('message','g',89,['code':("springSecurity.login.header")],-1)
printHtmlPart(5)
...
printHtmlPart(9)
invokeTag('message','g',97,['code':("springSecurity.login.username.label")],-1)
printHtmlPart(10)
...
printHtmlPart(14)
invokeTag('message','g',108,['code':("springSecurity.login.remember.me.label")],-1)
printHtmlPart(15)
...
public static final long LAST_MODIFIED = 1423501378723L
